...
| L-08 | ในฐานะผู้เรียน ฉันต้องการเรียน Module ถัดไปได้หลังจากจบ Module ก่อนหน้าแล้วเท่านั้น | Must |
...
| FR-COURSE-03 | แต่ละ Module ประกอบด้วยเนื้อหา: คลิปวิดีโอ (อาจมากกว่า 1 คลิป), ไฟล์เอกสาร/ใบความรู้ (อาจมากกว่า 1 ไฟล์), ลิงก์เพิ่มเติม | Must |
...
| ID | Requirement | Priority |
|----|------------|----------|
| FR-PREREQ-01 | ผู้เรียนต้องเรียนจบ 1 Module ก่อน จึงจะเรียน Module ถัดไปได้ (Sequential) | Must |
...
| FR-TEST-02 | คำถามรองรับ 3 ประเภท: Multiple choice (เลือกตอบ), Essay (เขียนบรรยายผ่านระบบ), File upload (อัปโหลดใบงาน) | Must |
